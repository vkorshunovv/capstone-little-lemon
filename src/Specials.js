        ...
        <section id='specialCards'>
            ...
            <div className='secondCardContainer'>
                <div className="card">
                    ...
                    <p>Our Bruschetta is made from grilled bread smeared with garlic and seasoned tomatoes, a flavorful blend complemented with salt and olive oil.</p>
                    <a href='#'>Order a delivery
                    <img src={scooterDelivery} alt='Delivery Scooter Icon' />
                    </a>
                    </div>
            ...
            <div className='thirdCardContainer'>
                <div className="card">
                    ...
                    <p>Derived from grandma's cherished recipe book, every last ingredient has been meticulously sourced, ensuring an unparalleled authenticity in taste.</p>
                    <a href='#'>Order a delivery
                    <img src={scooterDelivery} alt='Delivery Scooter Icon' />
                    </a>
                    </div>
