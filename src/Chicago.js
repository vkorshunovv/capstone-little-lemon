    ...
    return (
        <div id="history">
            <div className="historyDescription">
                ...
                <span>Chicago</span>
                <p>Little Lemon is owned by two Italian brothers, <strong><em>Mario</em></strong> and <strong><em>Adrian</em></strong>, who moved to the United States to pursue their shared dream of owning a restaurant.</p>
